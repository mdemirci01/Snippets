...
namespace Snippets.Controllers
{
    public class SnippetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Code,Language")] Snippet snippet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Code,Language")] Snippet snippet)
        {
            if (ModelState.IsValid)
            {
